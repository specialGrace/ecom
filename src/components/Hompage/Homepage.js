...
import {HiMenu, HiQuestionMarkCircle, HiSearch, HiOutlineX } from "react-icons/hi"
import { ShoppingCartIcon} from '@heroicons/react/outline'
import { useSelector } from 'react-redux'
import Cart from '../ShoppingCart/Cart'

const currencies = ['CAD', 'NGN', 'USD', 'AUD', 'EUR', 'GBP']
const navigation = {
  categories: [
    {
      name: 'Women',
                    ...
                    <Tab.Panel key={category.name} className="px-4 py-6 space-y-12">
                      <div className="grid grid-cols-2 gap-x-4 gap-y-10">
                        {category.featured.map((item) => (
                          ...
                          <Link to="/product" className="mt-6 block text-sm font-medium text-gray-900">
                                          ...
                                          <div className="grid grid-cols-4 gap-y-10 gap-x-8 py-16">
                                            {category.featured.map((item) => (
                                              <div key={item.name} className="group relative">
                                               ...
                                               <Link to="/" className="mt-4 block font-medium text-gray-900">
                                                  <span className="absolute z-10 inset-0" aria-hidden="true" />
                                                  {item.name}
                                              </Link>
                     ...
                     <Link to="#" className="hidden text-sm font-medium text-white lg:block">
                      ...
                      <div className="flex items-center lg:ml-8">
                       ...
                       <Link to="#" className="p-2 text-white lg:hidden">
                          ...
                          <HiQuestionMarkCircle className="w-6 h-6" aria-hidden="true" />
                      </Link>
                       <Link to="#" className="hidden text-sm font-medium text-white lg:block">
                          Help
                      </Link>
                        ...
                        <div className="ml-4 flow-root lg:ml-8">
                         <Link to="/cart" className="group -m-2 p-2 flex items-center">
                            <ShoppingCartIcon className="flex-shrink-0 h-6 w-6 text-white" aria-hidden="true" />
                            <span className="ml-2 text-sm font-medium text-white">{totalItems}</span>
        ...
        >
          ...
          <div className="mt-10 space-y-12 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-x-8">
            {collections.map((collection) => (
              <Link to="/" key={collection.name} className="group block">
                <div
                  aria-hidden="true"
